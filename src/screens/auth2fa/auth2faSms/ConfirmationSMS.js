...
const ConfirmationSMS = ({ navigation, route, navigation: { goBack } }) => {
  ...
  return (
    <BackgroundWrapper showNavigation={true}  navigation={navigation}>
      ...
      <Divider height-20 />
      <Text h13 white regular>Reguerda reingresar el código que recibirás en tu móvil cada vez que inicies sesión o realices una transacción. </Text>
      <Divider height-20 />
